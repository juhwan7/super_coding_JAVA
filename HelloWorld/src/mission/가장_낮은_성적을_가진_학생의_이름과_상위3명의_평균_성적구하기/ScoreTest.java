...
// List 제공
        ...
        // 1. 남학생들 중 가장 낮은 성적을 가진 학생의 이름 출력하기
        ...
        // 2. 여학생들 중 성적 상위 3명의 평균 성적 구하기
        double femaleStudentsCount = students.stream().filter(student -> student.getGender().equals("여자")).count();
