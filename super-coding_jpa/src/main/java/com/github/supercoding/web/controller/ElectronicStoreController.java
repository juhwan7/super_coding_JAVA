...
public class ElectronicStoreController {
    ...
    @ApiOperation("여러 Item type 검색 (쿼리문)")
    ...
    public Page<Item> findItemsPagination(@RequestParam("type") List<String> type, Pageable pageable) {
        return electronicStoreItemService.findAllWithPageable(type,pageable);
    }
}
